...
# 绘制数据
im = ax.pcolormesh(lon, lat, tp[0,:,:]*1000, cmap='jet', transform=ccrs.PlateCarree())
...
# 设置标题和坐标轴标签
timestr = f'{year[0]:02}-{month[0]:02}-{day[0]:02} {hour[0]:02}:00:00 UTC'
...
crop_image("D:\\Desktop\\Figure_2.png", 0.75)