...
dirpath = 'D:\\Repositories\\June11th-Jiangxi_case_figures\\fig_era5'  # or 'D:\\Repositories\\June11th-Jiangxi_case_figures\\fig_wrfout (scheme 1, terrain contrast)'
...
'''
dim1 = dim1s[1] # 0 is d01,             1 is d02.
...
#            os.path.join(dirpath, 'Scheme 1, ' + dim3.lower() + '24h, ' + dim1)
'''''''''''''''''''''''''''
↑ normal wrfout format
----------------------
era 5 ↓
'''''''''''''''''''''''''''
picpath = os.path.join("D:\\Repositories\\June11th-Jiangxi_case_figures\\fig_era5", dim2 + dim1)  # for era5
savepath = os.path.join(dirpath, f"tp_rain24h_{dim2 + dim1}")
'''''''''''''''''''''''''''
era 5 ↑
----------------------
↓ contrast wrfout format
'''''''''''''''''''''''''''
...
print(os.path.join(picpath, "tp_*"))  # print paths of the directory where pictures are
im_paths = glob.glob(os.path.join(picpath, "tp_*"))  # obtain all images' paths, or im_paths = glob.glob(picpath + "tp_*")
